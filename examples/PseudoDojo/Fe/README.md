# Iron (Fe) Example with PseudoDojo Pseudopotentials

This example demonstrates how to generate Quantum ESPRESSO and Wannier90 input files for iron (Fe) using PseudoDojo pseudopotentials with spin-orbit coupling and magnetic calculations.

## Overview

This example shows:
- **Material**: Iron (Fe) - a ferromagnetic metal
- **Pseudopotentials**: PseudoDojo standard UPF files
...
- **`scf.in`** - Self-consistent field calculation
  ...
  - Energy cutoffs: 106 Ry (wavefunction), 424 Ry (density)
...
2. **PseudoDojo pseudopotentials**: [Comp. Phys. Comm. 226, 39 (2018)](https://doi.org/10.1016/j.cpc.2018.01.012)
