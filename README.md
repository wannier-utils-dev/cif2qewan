...
- [ Iron-based binary ferromagnets for transverse thermoelectric conversion,  A. Sakai, S. Minami, T. Koretsune et al. ] ( https://doi.org/10.1038/s41586-020-2230-z  "Nature 581 53-57 (2020)" )
  The database of anomalous Hall conductivity and anomalous Nernst conductivity is generated using cif2qewan.py.

- [ Systematic first-principles study of the on-site spin-orbit coupling in crystals ] ( https://doi.org/10.1103/PhysRevB.102.045109  'Phys. Rev. B 102 045109 (2020)' )
  The spin-orbit coupling is extracted from the tight-binding models generated by cif2qewan.py.
